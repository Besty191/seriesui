local UF = {RainbowColorValue = 0, HueSelectionPosition = 0}
...
local UFLib = Instance.new("ScreenGui")
UFLib.Name = "UnfazedFreeui"
UFLib.Parent = game.CoreGui
UFLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

coroutine.wrap(
	function()
		while wait() do
			UF.RainbowColorValue = UF.RainbowColorValue + 1 / 255
			UF.HueSelectionPosition = UF.HueSelectionPosition + 1

			if UF.RainbowColorValue >= 1 then
				UF.RainbowColorValue = 0
			end

			if UF.HueSelectionPosition == 80 then
				UF.HueSelectionPosition = 0
			end
		end
	end
)()
...
function UF:Window(text, bottom,mainclr,toclose)
	...
	LeftFrame.Size = UDim2.new(0, 207,0, 421)
	...
	Title.Position = UDim2.new(0.0634146333, 0, 0.0330578536, 0)
    Title.Size = UDim2.new(0, 142, 0, 32)
    ...
    TabHold.Position = UDim2.new(0.0634146333, 0, 0.169421494, 0)
    TabHold.Size = UDim2.new(0, 181, 0, 329)
	...
	MainFrame:TweenSize(UDim2.new(0, 685,0, 421), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
	...
	function UF:Notification(desc,buttontitle)
		...
		NotificationBase.Size = UDim2.new(0, 706,0, 421)
	...
	function Tabs:Tab(text,ico)
		...
		Tab.Size = UDim2.new(0, 183.5, 0, 32.5)
		...
		Container.Size = UDim2.new(0, 457, 0, 400)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			Button.Size = UDim2.new(0, 450, 0, 43)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if BtnDescToggled == false then
					...
					Button:TweenSize(UDim2.new(0, 450, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		function ContainerContent:Toggle(text, desc,default, callback)
			...
			Toggle.Size = UDim2.new(0, 450, 0, 43)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if ToggleDescToggled == false then
					...
					Toggle:TweenSize(UDim2.new(0, 450, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			Dropdown.Size = UDim2.new(0, 450, 0, 43)
			...
			Dropdown.MouseButton1Click:Connect(function()
				if DropToggled == false then
					...
					Title.Text = Selected
					Dropdown:TweenSize(UDim2.new(0, 450, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Colorpicker.Size = UDim2.new(0, 450, 0, 43)
			...
			ColorpickerBtn.MouseButton1Click:Connect(function()
				if ColorPickerToggled == false then
					...
					ColorSelection.Visible = false
					HueSelection.Visible = false
					Colorpicker:TweenSize(UDim2.new(0, 450, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
				...
				function()
					...
					if RainbowColorPicker then
						...
						while RainbowColorPicker do
							BoxColor.BackgroundColor3 = Color3.fromHSV(UF.RainbowColorValue, 1, 1)
							Color.BackgroundColor3 = Color3.fromHSV(UF.RainbowColorValue, 1, 1)

							ColorSelection.Position = UDim2.new(1, 0, 0, 0)
							HueSelection.Position = UDim2.new(0.48, 0, 0, UF.HueSelectionPosition)
		...
		function ContainerContent:Label(text)
			...
			Label.Size = UDim2.new(0, 450, 0, 43)
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			Textbox.Size = UDim2.new(0, 450, 0, 43)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if TextboxDescToggled == false then
					...
					Textbox:TweenSize(UDim2.new(0, 450, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Bind.Size = UDim2.new(0, 450, 0, 43)
